...
- **zne**. Additional zero-noise extrapolation mitigation options.  
  ...
  - **noise_factors**. Unset or a sequence of floats.  
  ...
  - **extrapolated_noise_factors**. Unset or a sequence of floats.  
...
- **pec**. Additional probabalistic error cancellation mitigation options.
  - **max_overhead**. Unset or float.
  - **noise_gain**. Unset, 'literal' or float (0 removal, 1 no removal, 0-1 partial removal, >1 amplifying).
